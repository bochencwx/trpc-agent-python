...
from trpc_agent_sdk.agents.dynamic._loader import load_archetype_from_file
from trpc_agent_sdk.agents.dynamic._loader import load_archetypes_from_dir
from trpc_agent_sdk.agents.dynamic._loader import _WHITELIST_NAMES
...
def test_whitelist_names_all_importable():
    from trpc_agent_sdk.agents.dynamic._loader import _tool_whitelist
    wl = _tool_whitelist()
