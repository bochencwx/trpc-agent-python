...
from trpc_agent_sdk.agents.dynamic._constants import ISOLATION_DEFAULTS
from trpc_agent_sdk.agents.dynamic._runner import _BorrowedToolSet
from trpc_agent_sdk.agents.dynamic._runner import _build_sub_agent
from trpc_agent_sdk.agents.dynamic._runner import _collect_parent_events
from trpc_agent_sdk.agents.dynamic._runner import _event_is_model_visible
from trpc_agent_sdk.agents.dynamic._runner import _extract_final_text
from trpc_agent_sdk.agents.dynamic._runner import _forward_artifacts
from trpc_agent_sdk.agents.dynamic._runner import _is_user_text_event
from trpc_agent_sdk.agents.dynamic._runner import _materialize_tools
from trpc_agent_sdk.agents.dynamic._runner import _resolve_model
...
async def test_run_subagent_with_mocked_runner() -> None:
    ...
    with patch("trpc_agent_sdk.runners.Runner", mock_runner_cls):
        from trpc_agent_sdk.agents.dynamic._runner import run_subagent
